<?php
    class Constants {
        ...
        public static $passwordNotAlphanumeric = "Your password can only contain alphabets and numbers";
        public static $passwordCharacters = "Your password must be between 5 and 30";
